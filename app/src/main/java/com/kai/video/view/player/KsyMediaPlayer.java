...
import com.kai.video.bean.obj.KsyTrackInfo;
...
public class KsyMediaPlayer extends AbstractMediaPlayer {
    ...
    public ITrackInfo[] getTrackInfo() {
        ...
        return KsyTrackInfo.fromMediaPlayer(mInternalMediaPlayer);
    }
    ...
    private class AndroidMediaPlayerListenerHolder implements
        ...
        public AndroidMediaPlayerListenerHolder(KsyMediaPlayer mp) {
            mWeakMediaPlayer = new WeakReference<>(mp);
        }
        @Override
        public boolean onInfo(IMediaPlayer mp, int what, int extra) {
            KsyMediaPlayer self = mWeakMediaPlayer.get();
