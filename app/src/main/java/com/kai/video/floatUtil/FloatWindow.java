...
public class FloatWindow {
    ...
    private static FloatWindow.OnDestroyListener onDestroyListener = null;

    public static void setOnDestroyListener(FloatWindow.OnDestroyListener onDestroyListener) {
        FloatWindow.onDestroyListener = onDestroyListener;
    }
    ...
    public static void destroy() {
        if (onDestroyListener == null)
            onDestroyListener.onDestory(GSYVideoManager.instance().getCurrentPosition());
        destroy(mDefaultTag);
    ...
    public static class B {
        ...
        public B setOnDestroyListener(FloatWindow.OnDestroyListener onDestroyListener){
            FloatWindow.onDestroyListener = onDestroyListener;
            return this;
        }
