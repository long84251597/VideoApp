...
public class IFloatWindowImpl extends IFloatWindow {
    ...
    IFloatWindowImpl(FloatWindow.B b) {
        ...
        FloatLifecycle mFloatLifecycle = new FloatLifecycle(mB.mApplicationContext, mB.mShow, mB.mActivities, new LifecycleListener() {
            @Override
            public void onShow() {
                show();
            }
    ...
    void postHide() {
        if (once || !isShow) return;
        getView().post(() -> getView().setVisibility(View.INVISIBLE));
        isShow = false;
    }
