...
public class Tools {
    ...
    public static void focusAnimator(View parentView, final View focusView, int scrollY, int offSetX, int offSetY) {
        ...
        @SuppressLint("ObjectAnimatorBinding") ValueAnimator scaleWidthAnimator = ObjectAnimator.ofFloat(focusView, "width", fromWidth, toWidth);
        scaleWidthAnimator.addUpdateListener(animation -> {
        ...
        @SuppressLint("ObjectAnimatorBinding") ValueAnimator scaleHeightAnimator = ObjectAnimator.ofFloat(focusView, "height", fromHeight, toHeight);
        scaleHeightAnimator.addUpdateListener(animation -> {
