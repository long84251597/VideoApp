...
public class InfoActivity extends BaseActivity{
    ...
    protected int getPhonePortLayout() {
        return R.layout.activity_info_none_phone;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ((TextView)findViewById(R.id.change_api)).setText(apiNames.get(0).replaceAll("\\[.*", ""));
            }
        }).start();
        ...
        layoutManager = new GridLayoutManager(InfoActivity.this, getCol());
        ...
        orientoinListener = MyOrientoinListener.getInstance(this);
        fullButton.setOnClickListener(v -> {
            ...
            //初始化不打开外部的旋转
            orientoinListener.setForceLand(true);
